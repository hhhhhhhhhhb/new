...
function App() {
  ...
  useEffect(() => {
    ...
    const resumeApiConfig = new ResumeConfiguration({ basePath: "https://app.jiyeon.shop" });
    ...
    // job backend Data
    const jobPostingApiConfig = new JobPostingConfiguration({ basePath: "https://job.jiyeon.shop" });
